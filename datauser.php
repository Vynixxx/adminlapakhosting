  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <div class="info">
          <a href="#" class="d-block">Thoriq NS</a>
        </div>
      </div>
                ...
                <table id="example2" class="table table-bordered table-hover">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td>Hosting</td>
                      <td class="btn btn-outline-primary mx-3 my-2 p-2">
                      <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-pen-fill" viewBox="0 0 16 16">
                        <path d="m13.498.795.149-.149a1.207 1.207 0 1 1 1.707 1.708l-.149.148a1.5 1.5 0 0 1-.059 2.059L4.854 14.854a.5.5 0 0 1-.233.131l-4 1a.5.5 0 0 1-.606-.606l1-4a.5.5 0 0 1 .131-.232l9.642-9.642a.5.5 0 0 0-.642.056L6.854 4.854a.5.5 0 1 1-.708-.708L9.44.854A1.5 1.5 0 0 1 11.5.796a1.5 1.5 0 0 1 1.998-.001z"/>
                      </svg>
                      </td>
                      <td class="btn btn-outline-danger my-2 p-2">
                  ...
                  <tr>
                    <tr>
                      <td>Cust_02</td>
                      <td><a href="pages/examples/invoice.html">OR9848</a></td>
                      <td>Tono Python</td>
                      <td>6283647589201</td>
                      <td>Surabaya, Jawa Timur</td>
                      <td>
                        <div class="sparkbar" data-color="#00a65a" data-height="20">sukapython@gmail.com</div>
                      </td>
                      <td>Epic Hosting</td>
                      <td class="btn btn-outline-primary mx-3 my-2 p-2">
                      <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-pen-fill" viewBox="0 0 16 16">
                    ...
                    <tr>
                      <td>Cust_03</td>
                      <td><a href="pages/examples/invoice.html">OR9844</a></td>
                      <td>Name</td>
                      <td>Phone</td>
                      <td>Loct</td>
                      <td>
                        <div class="sparkbar" data-color="#00a65a" data-height="20">Email</div>
                      </td>
                      <td>Hosting</td>
                      <td class="btn btn-outline-primary mx-3 my-2 p-2">
                      <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-pen-fill" viewBox="0 0 16 16">
                    ...
                    <tr>
                      <td>Cust_04</td>
                      <td><a href="pages/examples/invoice.html">OR9846</a></td>
                      <td>Name</td>
                      <td>Phone</td>
                      <td>Loct</td>
                      <td>
